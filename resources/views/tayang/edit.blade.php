        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Edit Acara Tayang</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('tayang.update', $tayang->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-body">
                            <div class="row p-t-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="acara" value="{{ $tayang->acara }}" class="form-control @error('acara') is-invalid @enderror">
                                        @error('acara')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                            <input type="text" name="mulai" value="{{ $tayang->mulai }}" class="form-control @error('mulai') is-invalid @enderror"> <span class="input-group-addon"> <span class="fa fa-clock-o"></span> </span>
                                            @error('mulai')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                                            <input type="text" name="selesai" value="{{ $tayang->selesai }}" class="form-control @error('selesai') is-invalid @enderror" name="selesai"> <span class="input-group-addon"> <span class="fa fa-clock-o"></span> </span>
                                            @error('selesai')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
